...
function onOrientationChange(event) {
    ...
    const distanceToReference = document.getElementById("mySlider").value;
    document.getElementById("myLabel").innerHTML=
        "Distance To Reference: " +distanceToReference+" m";
        // "Distance to reference: " +distanceToReference+" m";
    ...
    ctx.fillText(distanceToTarget.toFixed(1)+"meters",CANVAS.width/2,CANVAS.height* 0.85);
